					...
					<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        ...
                        <nav class="flex px-5 py-3 text-gray-700  bg-gray-50 dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
                            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                                ...
                                <a href="{{ route('managetuition.index') }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
                                ...
                                <tbody>
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <form action="{{ route('managetuition.destroy',$users->userid) }}" method="POST">
                                            <a class="font-medium text-blue-600 dark:text-blue-500 hover:underline" href="{{ route('managetuition.edit',$users->userid) }}">Modify</a>
                                                @csrf
                                                @method('DELETE')
                                                @php
                                                $txtbutton = '';
