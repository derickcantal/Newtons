					...
					<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        ...
                        <nav class="flex px-5 py-3 text-gray-700  bg-gray-50 dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
                            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                                ...
                                <a href="{{ route('manageer.index') }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
                        ...
                        <div class="relative bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                            <div class="flex flex-col items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
                                <x-primary-button class="ms-4">
                                    <a class="btn btn-primary" href="{{ route('manageer.create') }}"> Create New Receiver</a>
                                </x-primary-button>
                                
                                <form class="flex items-center" action="{{ route('manageer.search') }}" method="get">
                                    @csrf
                                ...
                                <tbody>
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <form action="{{ route('manageer.destroy',$users->userid) }}" method="POST">
                                            <a class="font-medium text-blue-600 dark:text-blue-500 hover:underline" href="{{ route('manageer.edit',$users->userid) }}">Modify</a>
                                                @csrf
                                                @method('DELETE')
                                                @php
                                                $txtbutton = '';
